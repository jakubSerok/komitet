...
const Home = () => {
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      />
      <div className="flex flex-col w-full gap-2 sm:flex-row justify-evenly">
        ...
        <div className="text-center p-4 bg-[#15631b] bg-opacity-30  text-[#f5df18] rounded-md mt-[30px] flex flex-col gap-3 font-bold border-4 border-[#15631b]">
          <p
      ...
      <div className="flex md:flex-row flex-col justify-center items-center gap-4 w-full h-full mt-[20px]">
        <div className="w-full p-4">
          <div className="bg-black p-4 rounded-lg mt-[50px] flex flex-col justify-center gap-4 max-w-[800px] border-4 border-blue-400 bg-opacity-40">
            ...
            <ol className="flex flex-col gap-4">
              ...
              <li>
                <p className="text-lg text-white md:text-xl">
                  <span className="font-bold text-blue-500">3. DROGI - </span>
        ...
        <div className="grid w-full grid-cols-1 gap-2 pr-2 md:grid-cols-2">
      ...
      <div className="text-center mt-[50px] p-4 border-4 border-red-700 bg-opacity-20 bg-black">
